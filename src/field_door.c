...
static const u8 sDoorAnimTiles_LumiereLab[] = INCBIN_U8("graphics/door_anims/lumiere_lab.4bpp");
static const u8 sDoorAnimTiles_LibertyGarden[] = INCBIN_U8("graphics/door_anims/liberty_garden.4bpp");
...
static const u8 sDoorAnimPalettes_LumiereLab[] = {0, 0, 0, 0};
static const u8 sDoorAnimPalettes_LibertyGarden[] = {11, 11, 11, 11};

static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    {METATILE_Petalburg_LH23,                               DOOR_SOUND_NORMAL,  0, sDoorAnimTiles_LibertyGarden, sDoorAnimPalettes_LibertyGarden},
    {METATILE_Petalburg_Lab_Door,                           DOOR_SOUND_NORMAL,  0, sDoorAnimTiles_LumiereLab, sDoorAnimPalettes_LumiereLab},
