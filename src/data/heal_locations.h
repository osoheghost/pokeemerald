static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CASIO_VILLAGE_1 - 1] = {MAP_GROUP(CASIO_VILLAGE), MAP_NUM(CASIO_VILLAGE), 13, 7},
    [HEAL_LOCATION_CASIO_VILLAGE_2 - 1] = {MAP_GROUP(CASIO_VILLAGE), MAP_NUM(CASIO_VILLAGE), 13, 5},
    [HEAL_LOCATION_CELANTO_TOWN - 1] = {MAP_GROUP(CELANTO_TOWN), MAP_NUM(CELANTO_TOWN), 37, 14},
};
