...
const u16 gMetatiles_FloatingRocks[] = INCBIN_U16("data/tilesets/secondary/floating_rocks/metatiles.bin");
const u16 gMetatileAttributes_FloatingRocks[] = INCBIN_U16("data/tilesets/secondary/floating_rocks/metatile_attributes.bin");
