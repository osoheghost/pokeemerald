...
#define HEAL_LOCATION_CASIO_VILLAGE 23
#define HEAL_LOCATION_CASIO_VILLAGE_1 24
#define HEAL_LOCATION_CELANTO_TOWN 25
#define HEAL_LOCATION_CASIO_VILLAGE_2 26
